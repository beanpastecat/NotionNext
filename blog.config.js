...
const BLOG = {
  AUTHOR: '豆沙小猫', // 作者
  BIO: '不写同人的同人女，同人女间谍', // 作者简介
  LINK: 'https://notion-next-six-henna.vercel.app/', // 网站地址
  ...
  CONTACT_EMAIL: '112633@protonmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '4b6c4490-0335-4a9f-a5dd-9289edf6486d', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
