...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hitchhiker', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '根本没人知道我每天顶着多大的压力在玩', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-weld-phi.vercel.app/', // 网站地址
